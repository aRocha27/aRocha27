...
|---|---|---|
| [`omp`](https://github.com/aRocha27/omp) | Paperfold (OMP) — a working Orders Management Platform for companies that want to modernize order, invoicing and operational workflows. Explore the public demo, and contact me if you want a tailored implementation for your organization. | **Status:** functional, sanitized for public demonstration | TypeScript · React/Vite · Node/Express · SQL Server · Docker |
